namespace GameModule.LeaderBoard.Scripts
{
    ...
    public interface ILeaderboardsService
    {
        ...
        UniTask                FetchLimitEntries(int limit = 10);
        UniTask                FetchAllEntries();
    ...
    public static class LeaderboardEntryCount
    {
        public static string Key { get; set; } = "leaderboardEntryCount";
    }
}
